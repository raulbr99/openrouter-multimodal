    ...
    <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-900">
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-2 sm:p-4">
        <div className="max-w-3xl mx-auto">
          <div className="flex gap-2 sm:gap-3 items-end flex-wrap sm:flex-nowrap">
            <div className="relative">
              <button
                onClick={() => setShowModelDropdown(!showModelDropdown)}
                className="flex items-center gap-2 pl-2 pr-2 sm:pl-3 sm:pr-3 py-2.5 border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:border-purple-400 dark:hover:border-purple-500 transition-all shadow-sm"
              >
                ...
                <span className="hidden sm:inline max-w-[120px] truncate">{model.split('/').pop()}</span>
            ...
            <button
              ...
              className={`p-2.5 sm:p-3 rounded-xl transition-all flex items-center gap-1.5 text-xs font-medium ${
                webSearchMode === 'on'
            ...
            >
              ...
              <span className="hidden sm:inline">{webSearchMode === 'auto' ? 'Auto' : webSearchMode === 'on' ? 'On' : 'Off'}</span>
            </button>
            {/* Settings button */}
            <div className="relative">
              <button
              ...
              {/* Settings panel */}
              {showSettings && (
                <div className="absolute bottom-full mb-2 right-0 w-64 sm:w-72 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-3 sm:p-4 z-10">
            ...
            <div className="flex-1 w-full sm:w-auto order-last sm:order-none">
              {/* Image Preview */}
              ...
              <div className="relative flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-2.5 sm:p-3 text-gray-500 hover:text-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-xl transition-all"
                ...
                <input
                  ...
                  onPaste={handlePaste}
                  placeholder={attachedImages.length > 0 ? "Mensaje..." : "Escribe o pega imagen..."}
                  className="flex-1 p-2.5 sm:p-3 pr-12 border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-sm sm:text-base"
                  disabled={loading}
                />
                <button
                  onClick={sendMessage}
