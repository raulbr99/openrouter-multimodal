          ...
          <div className="flex gap-3 items-end">
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 pl-3 pr-3 py-2.5 border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:border-purple-400 dark:hover:border-purple-500 transition-all shadow-sm"
              >
                ...
                <span className="max-w-[120px] truncate">{model.split('/').pop()}</span>
